  ...
  return (
    <>
      <Button
        variant="ghost"
        size="sm"
        className="h-8 gap-2 px-2 text-muted-foreground shadow-none border border-border"
        onClick={() => setOpen(true)}
      >
        <IconSearchFilled className="size-4" />
        <span className="hidden text-sm sm:inline-flex">Search Documentation...</span>
